...
Component.prototype.onInstallationStarted = function () {
  if (component.updateRequested() || component.installationRequested()) {
    if (installer.value('os') == 'win') {
      component.installerbaseBinaryPath =
        '@TargetDir@/signedmaintenancetool.exe'
    }
...
Component.prototype.installVCRedist = function () {
  var registryVC2017x64 = installer.execute(
    'reg',
    new Array(
      'QUERY',
  ...
  if (doInstall) {
    QMessageBox.information(
      ...
      'The application requires Visual Studio 2017 Redistributables. Please follow the steps to install it now.',
      QMessageBox.OK,
    )
    var dir =
      installer.value('TargetDir') + '/' + installer.value('ProductName')
...
Component.prototype.createOperations = function () {
  ...
  if (systemInfo.productType === 'windows') {
    ...
    component.addOperation(
      ...
      'iconPath=@TargetDir@/@ProductName@/@ProductName@.exe',
      'iconId=0',
